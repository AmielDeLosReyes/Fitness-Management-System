package com.gs.grit.controllers.unit;
// Import statements
...
// Specify the test environment and use a random port
...
public class BMIControllerTest {
    ...
    // Autowire the controller to be tested
    @Autowired
    private BMIController bmiController;

    // Test method for the calculateBMI endpoint
    @Test
